...
public class StreamExercise {
    ...
    public void task5() {
        ...
        // todo: write your code here
        dates = people.stream().map(Person::getDateOfBirth).filter(Objects::nonNull).collect(Collectors.toCollection(TreeSet::new));
    ...
    public void task9() {
        ...
        dtoList = people.stream()
                .filter(p -> p.getDateOfBirth() != null && p.getDateOfBirth().isBefore(date))
                .map(p -> new PersonDto(
                        p.getPersonId(),
    ...
    public void task10() {
        ...
        optional = people.stream()
                ...
                .map(date -> date.format(DateTimeFormatter.ofPattern("EEEE d MMMM uuuu", Locale.ENGLISH)))
